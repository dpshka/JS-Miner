<template>
  <div class="loading">
    <div class="loading-inside">
      ...
      >
        <path
          d="M336.954,87.494C318.821,59.1,293.251,36.318,263.01,21.613l-13.119,26.979c52.77,25.661,85.551,78.029,85.551,136.669
...
<style scoped>
.loading {
  @apply w-full h-auto p-[40px];
}
.loading-inside {
  @apply w-[30px] h-[30px] m-auto animate-spin;
}
</style>
